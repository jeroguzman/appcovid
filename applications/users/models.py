...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    edad = models.PositiveIntegerField(validators=[MinValueValidator(0), MaxValueValidator(100)], null=True, blank=True)
    ...
    cp = models.PositiveIntegerField(validators=[RegexValidator('r^\d{5}$')], null=True, blank=True)
